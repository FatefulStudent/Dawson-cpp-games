...
void greetings();
void drawTutorialBoard(const vector<int>* const board);
void drawBoard(const vector<char>* const board);
bool isPlayerFirst();
int getPlayerMove(const vector<char>* const board);
int getComputerMove(const vector<char>* const board);
void updateBoard(vector<char>* const board, int move, char tick, 
                 int* const moveCounter);
...
char checkWin(const vector<char>* const board, char tick, int moveCounter)
{
    for (int i=0; i<3; i++)
